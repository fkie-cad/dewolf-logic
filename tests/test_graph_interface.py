"""Implementing tests for the graph interface."""
from typing import List, Tuple

import pytest

from simplifier.world.graphs.interface import BasicEdge, BasicNode, GraphInterface
from simplifier.world.graphs.nxgraph import NetworkXGraph as Graph
...
class TestGraphInterface:
    ...
    def test_subgraph(self):
        ...
        assert isinstance(subgraph, GraphInterface)
